...
- Groups are listed in column order. A group opened at runtime landed after
  groups with a higher column, so the list could read 1, 3, 2, 4.
...
- The extension icon's rows are a neutral grey instead of a blue slate.

## [0.4.12] - 2026-09-09

### Changed

- The extension icon carries an amber band instead of a pink one.
